...
import { addHotSearchWords, queryHotSearchWords, removeHotSearchWords, updateHotSearchWords, queryHotSearchWordsVerboseName, queryHotSearchWordsListDisplay, queryHotSearchWordsDisplayOrder} from './service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryHotSearchWordsDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryHotSearchWordsListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryHotSearchWords, table_columns, '热搜排行-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, '热搜排行-select')
                    }
                  }}
                  selectedKeys={[]}
                >
