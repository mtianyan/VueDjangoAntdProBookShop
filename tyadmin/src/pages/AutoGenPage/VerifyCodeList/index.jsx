...
import { addVerifyCode, queryVerifyCode, removeVerifyCode, updateVerifyCode, queryVerifyCodeVerboseName, queryVerifyCodeListDisplay, queryVerifyCodeDisplayOrder} from './service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryVerifyCodeDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryVerifyCodeListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryVerifyCode, table_columns, '短信验证-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, '短信验证-select')
                    }
                  }}
                  selectedKeys={[]}
                >
