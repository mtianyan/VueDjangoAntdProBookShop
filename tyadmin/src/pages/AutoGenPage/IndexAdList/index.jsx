...
import { addIndexAd, queryIndexAd, removeIndexAd, updateIndexAd, queryIndexAdVerboseName, queryIndexAdListDisplay, queryIndexAdDisplayOrder} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryGoodsCategory, queryGoodsCategoryVerboseName} from '@/pages/AutoGenPage/GoodsCategoryList/service';import {queryGoods, queryGoodsVerboseName} from '@/pages/AutoGenPage/GoodsList/service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryIndexAdDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryIndexAdListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryIndexAd, table_columns, '首页广告-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, '首页广告-select')
                    }
                  }}
                  selectedKeys={[]}
                >
