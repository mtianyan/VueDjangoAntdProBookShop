...
import {addVerifyCode, queryVerifyCode, removeVerifyCode, updateVerifyCode} from './service';
...
const TableList = () => {
  ...
  try {
    await updateVerifyCode(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索短信验证 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryVerifyCode({...params, sorter, filter})}
