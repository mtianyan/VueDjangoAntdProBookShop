...
import {addShoppingCart, queryShoppingCart, removeShoppingCart, updateShoppingCart} from './service';
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索购物车喵 " onSearch={value => {
            setParamState({
              search: value,
            });
