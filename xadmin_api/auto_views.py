...
from xadmin_api.auto_serializers import UserProfileSerializer, VerifyCodeSerializer, GoodsCategorySerializer, GoodsCategoryBrandSerializer, \
    GoodsSerializer, GoodsImageSerializer, BannerSerializer, IndexAdSerializer, HotSearchWordsSerializer, ShoppingCartSerializer, OrderInfoSerializer, \
    OrderGoodsSerializer, UserFavSerializer, UserAddressSerializer, UserLeavingMessageSerializer, VersionControlSerializer
from xadmin_api.auto_filters import UserProfileFilter, VerifyCodeFilter, GoodsCategoryFilter, GoodsCategoryBrandFilter, GoodsFilter, GoodsImageFilter, \
    BannerFilter, IndexAdFilter, HotSearchWordsFilter, ShoppingCartFilter, OrderInfoFilter, OrderGoodsFilter, UserFavFilter, UserAddressFilter, \
    UserLeavingMessageFilter, VersionControlFilter
