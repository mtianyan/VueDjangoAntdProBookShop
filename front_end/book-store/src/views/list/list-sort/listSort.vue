...
.search_num span.search_btn a:hover{border-color:#ccc;box-shadow:0 1px 1px #eee;text-decoration:none;color:#A7B9C3}
.search_num span.search_btn span{color:#333}
.search_num span.search_btn span em{color:#A7B9C3}
